...
public class Restaurante  implements java.io.Serializable {
    ...
    public Restaurante(int id , String nombre, String tipoComida, String direccion, double valoracion, double pedidoMinimo, String horaApertura, String horaCierre) {
        this.nombre = nombre;
        this.id = id;
